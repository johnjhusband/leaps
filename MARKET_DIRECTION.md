...
- Genuinely undervalued: **185/910 = 20%** of the valued tradable universe.
- Rule `stock = min(100%, undervalued% ÷ 50%)` -> **41% stocks (the 185 buy-list names) / 59% bonds-short-term.**
