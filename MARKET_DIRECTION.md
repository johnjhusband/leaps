...
- Genuinely undervalued: **269/910 = 30%** of the valued tradable universe.
- Rule `stock = min(100%, undervalued% ÷ 50%)` -> **59% stocks (the 269 buy-list names) / 41% bonds-short-term.**
